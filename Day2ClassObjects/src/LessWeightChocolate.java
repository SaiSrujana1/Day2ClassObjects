...
public class LessWeightChocolate {
	...
	public static void main(String[] args) {
		...
		Chocolate[] chocolateArray=new Chocolate[10];
		   ...
		   double  cost1 = chocolateArray[0].weight;
		   for(int i=1;i<chocolateArray.length;i++)
		   {
			   if(chocolateArray[i].weight<cost1)
			   {
				   cost1 =chocolateArray[i].weight;
